...
class notfiy_screen extends StatefulWidget {
  static String id = 'notfiy_screen';
  @override
  notfiy_screenState createState() => notfiy_screenState();
}

class notfiy_screenState extends State<notfiy_screen> {
