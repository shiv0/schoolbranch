...
class msg_lists extends StatefulWidget {
  static String id = 'msg_list';
  @override
  _msg_listsState createState() => _msg_listsState();
}

class _msg_listsState extends State<msg_lists> {
...
//                                      ),
                            ...
                            onPressed: () {
                              Navigator.pushReplacementNamed(
                                  context, msg_received_teacher.id);
                            },
                          ),
                        ),
                      ),
