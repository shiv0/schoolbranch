...
class Cards_Details_BH extends StatefulWidget {
  static String id = 'card_details_BH';
  @override
  _Cards_Details_BHState createState() => _Cards_Details_BHState();
}

class _Cards_Details_BHState extends State<Cards_Details_BH> {
  String duration,
      pduration = "",
      date,
      pstart_date = "",
                        ...
                        GestureDetector(
                          ...
                          child: IgnorePointer(
                            child: TextFormField(
                              ...
                              keyboardType: TextInputType.text,
                              decoration:
                                  InputDecoration(hintText: pstart_date),
                            ),
                          ),
                        ),
                        SizedBox(
                        ...
                        GestureDetector(
                          ...
                          child: IgnorePointer(
                            child: TextFormField(
                              ...
                              keyboardType: TextInputType.text,
                              decoration: InputDecoration(hintText: pend_date),
                            ),
                          ),
                        ),
                        SizedBox(
...
//        'pincode': pincode,
  ...
  void Edit() {
    Navigator.pushReplacementNamed(context, Edit_Card_BH.id, arguments: {
